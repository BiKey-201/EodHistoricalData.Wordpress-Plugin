<div class="eod_admin_header">
    ...
    <nav>
        ...
        <a class="eod_btn"style="background-color: #4FB6D6;" href="https://eodhistoricaldata.com/register/?utm_source=p_c&utm_medium=wp_plugin&utm_campaign=new_wp" target="_blank">
            Get API Key
        </a>
        <?php }else{ ?>
            <a class="eod_btn"style="background-color: #4FB6D6;" href="https://eodhistoricaldata.com/pricing?utm_source=p_c&utm_medium=wp_plugin&utm_campaign=new_wp" target="_blank">
                Update to PRO
            </a>
        <?php } ?>
    </nav>
